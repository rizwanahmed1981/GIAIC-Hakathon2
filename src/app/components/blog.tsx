...
const Blog = () => {
  return (
    ...
    <div className='flex flex-col gap-10 my-10 md:mt-20 md:h-[1044px] md:w-full'>
      <div className='flex flex-col text-center items-center  gap-4'>
        ...
        <p className='text-[14px] font-normal text-[@737373] opacity-100'>Problems trying to resolve the conflict between <br />
        ...
        {BlogCard.map((item, index) => {
          return (
            <div key={index} className='flex flex-col gap-2'>
              ...
              <div className='w-[298px] h-[46px] text-[12px] font-normal opacity-100 flex flex-row justify-between gap-6 md:ml-6 md:mr-'>
